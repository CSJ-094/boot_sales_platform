...
<body>
    ...
    <section class="mypage-content-area">
      ...
      <c:if test="${not empty member}">
        <div class="info-form">
          <div class="form-group"><label>아이디</label> ${member.memberId}</div>
          <div class="form-group"><label>이름</label> ${member.memberName}</div>
          <div class="form-group"><label>이메일</label> ${member.memberEmail}</div>
          <div class="form-group"><label>전화번호</label> ${member.memberPhone}</div>
          <div class="form-group"><label>우편번호</label> ${member.memberZipcode}</div>
          <div class="form-group"><label>상세주소</label> ${member.memberAddr1}</div>
          <div class="form-group"><label>상세주소2</label> ${member.memberAddr2}</div>
        </div>
